//*****************************************************************************************************************************
// FCFS.java - August 10 2016
// Nick Simmons T00033019
// CPU Scheduling First Come First Server
//*****************************************************************************************************************************
...
public class FCFS
{
	public static void main(String args[])
	{
		...
		final int SIMULATION_TIME = 7200000; // 1 hrs
		
		// for computations of averages
		int averageTurnAroundTime = 0;		
		int averageWaitingTime = 0;

		int cpuLoadTime = 0; // use as count down timer
		int processCount = 0; // completed processes for average calculation
		...
		for (int currentTime = 0; currentTime < SIMULATION_TIME; currentTime++)
		{
			...
			// if buffer is empty, read process from simulation file
			if (pcb == null)
			{
				// load process
